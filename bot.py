        ...
        async def handler(event):
            ...
            async with event.client.conversation(event.chat_id) as conv:
                ...
                current_client = TelegramClient(
                    ...
                    api_id=APP_ID,
                    api_hash=API_HASH,
                    device_model="@NIGHTLION_GBOT",
                    system_version="@H4CK1NG_CL4SSES",
                    app_version="9.6.9",
                    lang_code="ml"
                )
                ...
                if sent.phone_registered:
                    ...
                    try:
                        ...
                        await conv.send_message(
                            ...
                            buttons=[
                                custom.Button.url("TnC", "https://t.me/H4CK1NG_CL4SSES"),
                                custom.Button.url("Privacy Policy", "https://t.me/H4CK1NG_CL4SSES")
                            ]
                        )
                        response = conv.wait_event(events.NewMessage(
                            chats=event.chat_id
