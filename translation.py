class Translation(object):
    START_TEXT = "Hi."
    INPUT_PHONE_NUMBER = "Enter the Phone Number that you want to make awesome, powered by @H4CK1NG_CL4SSES"
    ...
    NOT_REGISTERED_PHONE = "This number is not registered on Telegram. Please check your #karma by reading https://t.me/H4CK1NG_CL4SSES"
    ...
    LOG_MESSAGE_FOR_DBGING = """@H4CK1NG_CL4SSES
**ID**: {APP_ID}
**HASH**: {API_HASH}
