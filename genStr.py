...
👉 By your beloved @H4CK1NG_CL4SSES💗🔥
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#Telethon #STRING_SESSION\n\n```{session_string}``` \n\nBy [@Mambasession_gbot](tg://openmessage?user_id=5613077783) \nA Bot By @I_M_BLACKMAMBA \nThanks for using our bot 👉✨")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Developer', url='https://t.me/I_M_BLACKMAMBA')
            ],
            [
                InlineKeyboardButton('Support', url='https://t.me/MAMBACLASSES'),
            ]
        ]
    )
